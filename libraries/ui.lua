...
local window = redwine.new()

local tab1 = window:createTab({name = "hi", default = false})

local _tab2 = window:createTab({name = "hello jareds brother", default = true})
local _themetab = window:initializeThemeTab()

local card1 = tab1:createCard({title = "card 1", section = "left"})
local card2 = tab1:createCard({title = "card 2", section = "right"})
local card3 = tab1:createCard({title = "card 3", section = "left"})

local _rTL1 = card1:richTextLabel({name = "rTL1", text = "hello <b>world</b>"})
local _rTL2 = card2:richTextLabel({name = "rTL2", text = "hello <i>world</i>"})
local _rTL3 = card3:richTextLabel({name = "rTL3", text = "hello <u>world</u>"})
...
local _button3 =
    card3:subtextbutton(
    {
        name = "subtext_button1",
        text = "button 3",
        subtext = "this is a subtext button",
        callback = function()
            print("subtext button 1 clicked")
        end
    }
)
local _toggle1 =
    card1:checkboxtoggle(
    {
        name = "checkbox_toggle1",
        text = "checkbox toggle 1",
        default = true,
        callback = function(value)
            print("checkbox toggle 1 value:", value)
        end
    }
)

local _toggle2 =
    card2:checkboxtoggle(
    {
        name = "checkbox_toggle2",
        text = "checkbox toggle 2",
        default = false,
        callback = function(value)
            print("checkbox toggle 2 value:", value)
        end
    }
)
...
local _textbox1 =
    card3:inputtextbox(
    {
        ...
        text = "",
        placeholder = "enter text...",
        post = "Text", -- or "FocusLost" or {"Text", "FocusLost"}
        callback = function(value)
            print("input textbox 1 value:", value)
        end
    }
)

local _textbox2 =
    card1:subtexttextbox(
    {
        name = "subtext_textbox1",
        text = "",
        subtext = "this is a subtext",
        placeholder = "enter text...",
        post = "FocusLost", -- or "FocusLost" or {"Text", "FocusLost"}
        callback = function(value)
            print("subtext textbox 1 value:", value)
        end
    }
)
...
local _textbox3 =
    card2:inlinetextbox(
    {
        name = "inline_textbox1",
        text = "",
        subtext = "jared?",
        placeholder = "enter text...",
        post = {"Text", "FocusLost"}, -- or "FocusLost" or {"Text", "FocusLost"}
        callback = function(value)
            print("inline textbox 1 value:", value)
        end
    }
)
...
local _keybind1 =
    card3:keybind(
    {
        ...
        callback = function(newKey)
            print("keybind 1 changed to:", newKey)
        end,
        onActivated = function()
            print("keybind 1 activated!")
        end
    }
)
...
local _keybind2 =
    card3:keybind(
    {
        ...
        callback = function(newKey)
            print("keybind 2 changed to:", newKey)
        end,
        onActivated = function()
            print("keybind 2 activated!")
        end
    }
)
...
local _dropdown1 =
    card1:dropdown(
    {
        ...
        onChanged = function(selected)
            print("dropdown 1 selected:", table.concat(selected, ", "))
        end
    }
)
local _dropdown2 =
    card2:dropdown(
    {
        ...
        onChanged = function(selected)
            print("dropdown 2 selected:", table.concat(selected, ", "))
        end
    }
)
...
local _colorpicker1 =
    card2:colorpicker(
    {
        ...
        default = Color3.fromRGB(255, 0, 0),
        onChanged = function(color)
            print("color picker 1 changed to:", color)
        end
    }
)
...
local _colorpicker2 =
    card3:colorpicker(
    {
        ...
        onChanged = function(color)
            print("color picker 2 changed to:", color)
        end
    }
)
